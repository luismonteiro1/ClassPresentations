...
::: notes
- Two girls at the bar, who do you talk to? Probably the one you find the most pretty
- That's why "the best" ones have more chances of reproducing (being picked)
- However, if this happened 100% of the time, eventually the population would be homogenous (all be the same or very similar)
:::
...
::: notes
- Chromosomes consist of DNA chains, which are composed of genes. These genes define the characteristics of an individual.
- The different values that genes can have are called alleles.
- The genome is the name given to all the genetic material of an individual.
- Genotype is the name given to the set of genes contained in the genome.
:::
...
::: notes
- Chromosomes over time define the phenotype of an individual.
